...
pygame.display.set_caption('The Rock')
light_grey = (200,200,200)
clock = pygame.time.Clock()
## left paddle
left_paddle_surf= pygame.image.load('pipi.jpg').convert_alpha()
left_paddle_y_pos = 150
left_paddle_rect = left_paddle_surf.get_rect(topleft = (30, left_paddle_y_pos))
## right paddle
right_paddle_surf = pygame.image.load('pipi.jpg').convert_alpha()
right_paddle_y_pos = 150
right_paddle_rect = right_paddle_surf.get_rect(topleft = (770, right_paddle_y_pos))
## background
background_surface = pygame.image.load('therock.jpg').convert_alpha()
## bogus
bogus_surf = pygame.image.load('rock_bogus.jpg').convert_alpha()
